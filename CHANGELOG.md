...
## [0.4.4] - 2025-05-03
### Fixed
- Fixed a bug making it impossible to handle expired cache records when using a `timedelta` as the expiry ([#8](https://github.com/umarbutler/persist-cache/issues/8)).
